...
describe('[Challenge] Puppet v2', function () {
    ...
    it('Exploit', async function () {
        ...
        var attackerETHBalance = await ethers.provider.getBalance(attacker.address);
        console.log('before ETH balance: ' + attackerETHBalance.toString())
        ...
        console.log('after ETH balance: ' + attackerETHBalance.toString())
