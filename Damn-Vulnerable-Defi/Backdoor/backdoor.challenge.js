...
describe('[Challenge] Backdoor', function () {
    ...
    it('Exploit', async function () {
        ...
        this.attackerContract = await (await ethers.getContractFactory('AttackBackDoor', attacker)).deploy(
            this.walletFactory.address,
        ...
        await this.attackerContract.connect(attacker).attack(attacker.address, users);
    });
