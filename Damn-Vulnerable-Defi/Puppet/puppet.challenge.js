...
describe('[Challenge] Puppet', function () {
    ...
    it('Exploit', async function () {
        ...
        console.log(depositRequired.toString()); // only require ~19.5ETH to loan all DVT tokens

        // calculation for the deposit required is dependant on the number of DVT tokens available on Uniswapv1 which is FLAWED!!!

        const EthBalance = await ethers.provider.getBalance(attacker.address);
        console.log(EthBalance.toString()) // attacker has ~34 ETH
