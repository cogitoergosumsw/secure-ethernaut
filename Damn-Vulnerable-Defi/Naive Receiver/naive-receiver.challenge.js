...
describe('[Challenge] Naive receiver', function () {
    ...
    it('Exploit', async function () {
        ...
        for (let i = 0; i < 10; i++) {
            ...
            // the pool cannot reject the user's request to take out the flash loan.
            // user's ETH balance will be drained out by the loan fees of 1 ETH every time the loan is given out
